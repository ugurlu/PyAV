...
cdef class VideoStream(Stream):
    ...
    cdef _decode_one(self, lib.AVPacket *packet, int *data_consumed):
        ...
        utils.debug_enter('VideoStream._decode_one:alloc') # MEMLEAK
        ...
        utils.debug_enter('VideoStream._decode_one:decode') # MEMLEAK
        with nogil:
        ...
        utils.debug_enter('VideoStream._decode_one:_init_properties')
